...
exercise_1 += "                        <tr>";
exercise_1 += "                            <td style=\"width:100%;\">";
exercise_1 += "                                <input type='text' name='fear_2' placeholder='2.' onchange='submitExcerise_1()'\/>";
exercise_1 += "                            <\/td>";
exercise_1 += "                            <td>";
...
exercise_1 += "                        <tr>";
exercise_1 += "                            <td style=\"width:100%;\">";
exercise_1 += "                                <input type='text' name='fear_3' placeholder='3.' onchange='submitExcerise_1()'\/>";
exercise_1 += "                            <\/td>";
exercise_1 += "                            <td>";
...
exercise_2 += "                    <tr>";
exercise_2 += "                        <td>";
exercise_2 += "                            <input type='text' name='fear_1' id='fear_1' placeholder='1.' onchange='submitExcerise_2()'\/>";
exercise_2 += "                        <\/td>";
exercise_2 += "                        <td>";
exercise_2 += "                            <input type='text' name='thought_1' onchange='submitExcerise_2()'\/>";
exercise_2 += "                        <\/td>";
exercise_2 += "                    <\/tr>";
exercise_2 += "                    <tr>";
exercise_2 += "                        <td>";
exercise_2 += "                            <input type='text' name='fear_2' placeholder='2.' onchange='submitExcerise_2()'\/>";
exercise_2 += "                        <\/td>";
exercise_2 += "                        <td>";
exercise_2 += "                            <input type='text' name='thought_2' onchange='submitExcerise_2()'\/>";
exercise_2 += "                        <\/td>";
exercise_2 += "                    <\/tr>";
exercise_2 += "                    <tr>";
exercise_2 += "                        <td>";
exercise_2 += "                            <input type='text' name='fear_3' placeholder='3.' onchange='submitExcerise_2()'\/>";
exercise_2 += "                        <\/td>";
exercise_2 += "                        <td>";
exercise_2 += "                            <input type='text' name='thought_3' onchange='submitExcerise_2()'\/>";
exercise_2 += "                        <\/td>";
exercise_2 += "                    <\/tr>";
exercise_2 += "                <\/table>";
exercise_2 += "            <\/form>";
