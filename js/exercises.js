...
exercise_1 += "                <br>";
exercise_1 += "                <br>";
exercise_1 += "                <b>Social Situations<\/b> (e.g. any kind of small talk, especially with strangers; asking for help; introducing myself to a people)";
exercise_1 += "                <br>";
exercise_1 += "                <br>";
exercise_1 += "                <b>Being Observed by Others<\/b> ";
exercise_1 += "                (e.g. walking into a crowded room; waiting in line; eating, drinking, or writing in front of others)";
exercise_1 += "                <br>";
exercise_1 += "                <br>";
exercise_1 += "                <b>Performing in Front of Others<\/b> (e.g. speaking up in a class discussion, or giving a presentation; being interviewed for a job)";
exercise_1 += "            <\/p>";
...
exercise_7 += "                 <td>";
exercise_7 += "                 <label>--<\/label>";
exercise_7 += "                 <table>";
exercise_7 += "                     <tr>";
exercise_7 += "                         <td>";
exercise_7 += "                             <label>Thought<\/label>";
exercise_7 += "                             <textarea type=\"text\" class=\"exercise_7_thought\" onchange=\"submitExcerise_7()\"><\/textarea>";
exercise_7 += "                         <\/td>";
exercise_7 += "                     <\/tr>";
exercise_7 += "                     <tr>";
exercise_7 += "                         <td>";
exercise_7 += "                             <label>Defusion Strategy<\/label>";
...
exercise_7 += "                                 <option value=\"IDENTIFYING_THOUGHTS\">Identifying Thoughts<\/option>";
exercise_7 += "                                 <option value=\"NAMING\">Naming Thoughts<\/option>";
exercise_7 += "                                 <option value=\"NAMING_TYPES\">Real Naming of Thoughts<\/option>";
exercise_7 += "                                 <option value=\"DITCH_MEANING\">Ditch The Meaning<\/option>";
exercise_7 += "                                 <option value=\"THANKING\">Thanking The Mind<\/option>";
exercise_7 += "                                 <option value=\"DR_PHIL\">Dr. Phil<\/option>";
exercise_7 += "                                 <option value=\"AWARENESS\">Awareness Of Thinking<\/option>";
exercise_7 += "                                 <option value=\"OBSERVE\">Observe Your Thoughts<\/option>";
exercise_7 += "                             <\/select>";
exercise_7 += "                         <\/td>";
exercise_7 += "                     <\/tr>";
exercise_7 += "                     <tr>";
exercise_7 += "                         <td>";
exercise_7 += "                             <label>What did you Notice?<\/label>";
...
function exercise_7_add_row(thought, notice, pageload) {
    ...
    row.id = "exercise_7_row_"+(row_number+1);
    ...
    entry += "                      <tr>";
    entry += "                          <td>";
    entry += "                              <label>Thought<\/label>";
    entry += "                              <textarea type=\"text\" class=\"exercise_7_thought\" onchange=\"submitExcerise_7()\" id='exercise_7_thought_"+(row_number+1)+"' value='"+thought+"'/><\/textarea>";
    entry += "                          <\/td>";
    entry += "                      <\/tr>";
    entry += "                      <tr>";
    entry += "                          <td>";
    entry += "                              <label>Defusion Strategy<\/label>";
    entry += "                              <select id=\"exercise_7_strategy_"+(row_number+1)+"\" class=\"exercise_7_strategy\" data-native-menu=\"false\" data-mini=\"true\" onchange=\"submitExcerise_7()\">";
    entry += "                                  <option value=\"none\"><\/option>";
    entry += "                                  <option value=\"IDENTIFYING_THOUGHTS\">Identifying Thoughts<\/option>";
    entry += "                                  <option value=\"NAMING\">Naming Thoughts<\/option>";
    entry += "                                  <option value=\"NAMING_TYPES\">Real Naming of Thoughts<\/option>";
    entry += "                                  <option value=\"DITCH_MEANING\">Ditch The Meaning<\/option>";
    entry += "                                  <option value=\"THANKING\">Thanking The Mind<\/option>";
    entry += "                                  <option value=\"DR_PHIL\">Dr. Phil<\/option>";
    entry += "                                  <option value=\"AWARENESS\">Awareness Of Thinking<\/option>";
    entry += "                                  <option value=\"OBSERVE\">Observe Your Thoughts<\/option>";
    entry += "                              <\/select>";
    entry += "                          <\/td>";
    entry += "                      <\/tr>";
    entry += "                      <tr>";
